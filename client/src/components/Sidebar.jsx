    ...
    <div className={`flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b
     ...
     transition-all duration-500 max-md:absolute left-0 z-1 ${!isMenuOpen && 
        ...
        <div className="flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md">
            ...
            placeholder='Search Chats' type="text" className='text-xs placeholder:text-gray-400 outline-none' />
        </div>
        ...
        <div>
            ...
            includes(search.toLowerCase())).map((chat)=>(
                ...
                flex justify-between group'>
                    ...
                    <img onClick={e => toast.promise(deleteChat(e,chat._id), {loading: 'deleting...'})} src={assets.bin_icon} className="hidden group-hover:block 
